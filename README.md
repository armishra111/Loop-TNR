...
The gradient is then $\nabla L = \frac{\partial L(X,Y,Z,W,P,Q,R,S)}{\partial Q}$ which then simplifies to $\nabla L = V(P,Q,R,S) \otimes \frac{\partial V(P,Q,R,S)}{\partial Q} - U(X,Y,Z,W) \otimes \frac{\partial V(P,Q,R,S)}{\partial Q}$
\\
